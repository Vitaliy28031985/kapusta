...
const AppNotification: React.FC<NotificationProps> = ({ type, title, text, onClose }) => {
        ...
        <div className="fixed w-full h-full top-0 left-0 z-50 bg-black bg-opacity-50">
            ...
            >
                ...
                <div className='flex justify-center'>
                    <button className=" bg-bt_col pt-4 pb-4 pl-8 pr-8 font-semibold text-lg text-white rounded-3xl hover:bg-blue-20 mt-6 focus:bg-blue-20" onClick={handleClose}>
                        OK
                    </button>
                </div>
            </div>
